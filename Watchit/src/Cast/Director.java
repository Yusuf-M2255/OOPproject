...
public class Director extends CastMember {
    public Director(String firstName, String lastName, String gender, String nationality, String socialMediaLink,Date dateOfBirth) {
        super(firstName,lastName,gender,nationality,socialMediaLink,dateOfBirth);
    }
